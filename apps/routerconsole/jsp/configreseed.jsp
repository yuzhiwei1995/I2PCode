...
<label><input type="radio" class="optbox" name="pmode" value="I2PBridge" <%=reseedHelper.pmodeChecked(5) %> >
<%=intl._t("I2P Bridge")%></label>
    (<%=intl._t("输入网桥行：混淆协议，网桥IP和端口")%>)<br>
...
<tr><td align="right"><b><%=intl._t("Bridge Line")%>:</b></td>
    <td><input name="bridgeline" type="text" value="<jsp:getProperty name="reseedHelper" property="bridgeline" />" ></td>
</tr>
